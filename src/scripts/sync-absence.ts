 ...
 * Sync Absence Script
 * 
 * This script synchronizes absence data from Gripp API to the local database.
 */

import { syncAbsence } from '../services/sync.service';

async function main() {
  try {
    console.log('Starting sync of absence data...');
    ...
    console.log('Absence data synced successfully');
    process.exit(0);
  } catch (error) {
