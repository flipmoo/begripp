 ...
 * 
 * This script synchronizes project data from Gripp API to the local database.
 */

import { syncProjects } from '../services/sync.service';

async function main() {
  try {
    console.log('Starting sync of projects...');
