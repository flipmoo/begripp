...
interface AbsenceSyncButtonProps {
  onSyncComplete?: () => void;
}

export function AbsenceSyncButton({ onSyncComplete }: AbsenceSyncButtonProps) {
  const { syncAbsence, isSyncing, lastSync, syncError } = useAbsenceSyncStore();
  ...
  const handleSync = async () => {
    ...
    await syncAbsence(formattedStartDate, formattedEndDate);
